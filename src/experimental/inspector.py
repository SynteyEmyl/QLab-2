"""inspector.py:
this script intends to inspect the upper integration
limits of the wave functions we are working with.
"""
...
import src.model.hydrogen as hy
import src.model.numerical_methods as methods
